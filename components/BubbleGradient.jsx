const BubbleGradient = () => {
  return (
    <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute start1/2 -top-10 w-[30%] h-[60%] bg-red-100 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000"></div>
